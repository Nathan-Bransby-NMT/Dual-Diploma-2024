...
// TODO:  Create a function that takes two numbers as arguments and returns their sum.
//      Notes: Don't forget to return the result.

// TODO: Create two variables number1 and number two and give them a value of 0

// TODO: Use your function to calculate the addition and save it in a variable total
...
<head>
    ...
    <!-- TODO:  7 make the title: Session 04 -->
...
<header class="bg-gray-800 text-white p-4">
    <div class="container mx-auto flex flex-row justify-between">
        ...
        <!-- TODO:  8 make the Topic "Exercise 02" -->
...
<main class="container mx-auto p-4 mt-4 gap-4 flex flex-col">
    <article class="bg-white rounded-lg shadow-md shadow-gray-500/20 p-6">
        <header>
            <!-- TODO:  9 make the heading "Function Exercise" -->
            <h2 class="text-2xl font-semibold mb-4">OUTPUT HEADING</h2>
        </header>
        <section>
            <?php
            // TODO: Using a suitable method to output results in the form shown
            //       in plain HTML below
            ?>
            <p> addition(3, 2) => 5 </p>
        </section>
...
<!-- TODO: Test your solution with the values below:
            ...
            Test 2:   addition(-3, -6) ➞ -9
            Test 3:   addition(7, 3) ➞ 10
            Test 4:   addition(0, 0) ➞ 0
 -->
